...
pub(crate) fn run(step: Step, input: &Vec<String>) -> CustomResult<String> {
    ...
    // naive way: use memory instead of efficient wrap and jump around while walking; or simply ...
    // good: very simple walker function, bad: needs memory, yet: probably still efficient and fast enough ;-)
